...
class Clarke_HubSpot_Integration {
    ...
    public static function get_calculator_fields() {
        return array(
            ...
            'lead_source' => 'Origem do Lead (HubSpot Tracking)',
    ...
    public static function get_default_mapping() {
        return array(
            ...
            'scores' => '',
            'all_answers' => '',
            'lead_source' => 'hs_analytics_source_data_2',
            'page_url' => '',
            'page_title' => '',
    ...
    public static function retry_sync($lead_id) {
        ...
        $lead_data = array(
            ...
            'lead_source' => isset($lead->lead_source) ? $lead->lead_source : '',
            'page_url' => isset($lead->page_url) ? $lead->page_url : '',
            'page_title' => isset($lead->page_title) ? $lead->page_title : '',
